...
\subsection{LLMs adjective assignment based on a told phrase}
...
The model is contraint to answer only yes or no. 
...
The phrases used are taken from the (\citet{dataset_napoletano}) and then translated using the tool
