...
Run function run_gpt_criminality() in main.py.  
...
multi agent pipeline: execute run_manager_assistant_test()
...
## Instruction to run experiments related to: Job assignment based on character descriptions
Baseline: run function run_gpt_jobs() in main.py. 

To get plots: execute file analysis_job_assignation/grafici/plot.py

multi agent: execute file analysis_job_assignation/associate_jobs_multiagent.py
