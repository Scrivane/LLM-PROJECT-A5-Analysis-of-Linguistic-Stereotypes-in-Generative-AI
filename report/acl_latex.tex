...
To compare roles and understand which one is better at reducing bias , we compute the following metric in which deltas between italiand and dialect are squared to ignore the direction of the bias:
\begin{equation}
