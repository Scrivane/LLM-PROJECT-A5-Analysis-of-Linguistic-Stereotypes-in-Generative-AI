...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{grafici_digre/divergence_baseline_values_dumbell.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{grafici_digre/divergence_multiagent_values_dumbell.png}
