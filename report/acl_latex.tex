...
\begin{figure}[H]
    ...
    \caption[Trait assignment role]{Divergence in trait assignments for each role, compared to the standard Italian baseline of that role, represented by the central vertical line (zero). }
